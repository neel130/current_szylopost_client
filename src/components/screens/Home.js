        ...
        <>
            ...
            {load ?
                ...
                <>
                    ...
                    {data.length < 1 ? <div> <h3 style={{ fontSize: "32px", fontWeight: "600", marginTop: "163px", padding: "22px", color: "#628e6f" }} > <span style={{ color: "grey" }} >welcome</span>  to szylopost please follow users to see their Post   </h3> <div data-target="modal1" className='modal-trigger'   > <button style={{ color: "black", background: "#8af0b2", borderRadius: "13px", marginLeft: "20px", padding: "8px" }}>Connect With People</button> </div> </div> :

                        <div style={{marginTop:"30px"}} className="home">
                                ...
                                data.map(item => {
                                    ...
                                    return (
                                        <div className="card home-card" key={item._id}>
                                            <h5 style={{ padding: "5px", fontSize: "19px" }}><Link to={item.postedBy._id !== state._id ? "/profile/" + item.postedBy._id : "/profile"}> <span className='profilepic2' > <img src={item.postedBy.pic} alt="" /> </span> <span style={{display:"inline-flex",flexDirection:"column"}}  > {item.postedBy.name} <span style={{fontSize:"11px",color:"#5e5b5b"}} > {format(item.createdAt)} <span style={{fontSize:"13px",color:"#5e5b5b"}} >{item.location?<>, <i style={{position:"relative",top:"8px",color:" rgb(157 157 196)"}} class="Tiny material-icons">location_on</i>{item.location}</>:<></>} </span>  </span>   </span>  </Link>
                                            ...
                                            {item.catagory === "audio" ?
                                                ...
                                                <>
                                                    ...
                                                    {!item.photo ? <div> </div> : <div className="card-image">
                                                        ...
                                                        {item.catagory === "video" ?
                                                            ...
                                                            :
                                                            <Link to={"/post/" + item._id} > <img src={item.photo} /> </Link>
                                                        }
                                                    </div>}
                                            ...
                                            <div className="card-content">
                                                ...
                                                {item.photo ? <div className='changelikeposition'>
                                                    ...
                                                    <h6 onClick={ShowLikeUser} >{item.likes.length} likes</h6>
                                            ...
                                            {!item.likes.length<=0?
                                             ...
                                             {item.disablecomment===true? <p></p> :
                                                <>
                                              <Link to={"/comments/" + item._id} >


                                              <div style={{marginBottom:"8px",color:"#808080e6",fontWeight:"500",fontSize:"15px"}} >
  
                                             { item.comments.length>0 ?  <p> View all  {item.comments.length} 
                                             {item.comments.length ===1 ?<> comment</>   : <> comments</>   }  </p>  
                                             : null
                                             }
                                                    ...
                                                    <div className="textScroller">
                                                        {
                                                            item.comments.map(record => {
                                                                ...
                                                                return (
                                                                    <div key={record._id}>
                                                                        <div onClick={() => setDeleteCmnt({postid:item._id,commentid: record._id,postedByid:record.postedBy._id,contentpostedBy:item.postedBy._id})} > 
                                                                         <SubComment   record={record} post={item} homedata={true} /> </div> 
                                       ...
                                       <Link to={"/comments/" + item._id} >
                                         ...
                                         <div style={{marginBottom:"8px",color:"#808080e6",fontWeight:"500",fontSize:"15px"}} >
                                           ...
                                           : null
                                            ...
                                            {item.disablecomment===true? <p style={{color:"#8080808c",fontSize:"13px",marginTop:"10px",marginLeft:"10px"}} >Comments Disabled</p> :
                                                <form onSubmit={(e) => {
                                                    e.preventDefault()
                    ...
                    <SocialShare currentPost={currentPost} />
                        ...
                        <CommentSetting deletCmnt={deletCmnt} ab={senddata} allPost={data} />
                </>
