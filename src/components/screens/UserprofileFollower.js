...
import Ufollowers from './UserProfileFollows/Ufollowers'
import '../style/profilefollower.css'
import {UserContext} from '../../App'



function UserprofileFollower({userProfile}) {
  ...
  return (
    ...
    {userProfile?.user.followers.map((item)=>{
     ...
     return(
        ...
        <Link  to={state?._id===item?"/profile": "/profile/"+item}> <div onClick={reload} > <Ufollowers followerid={item} /></div>   </Link>
     )
